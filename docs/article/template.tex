...
% Title.
% ------
\title{IMPLEMENTASI MODUL INDEXING PADA SEARCH 
ENGINE TELUSURI DENGAN INTEGRASI INVERTED INDEX DAN GENERALIZED SUFFIX TREE 
UNTUK MEREDUKSI WAKTU PENCARIAN}
%
% Single address.
% ---------------
\name{Mochammad Hanif Ramadhan, Med Irzal, Muhammad Eka Suryana}
\address{hanifrmn@protonmail.com, med-irzal@unj.ac.id, eka-suryana@unj.ac.id}
%
% For example:
% ------------
%\address{School\\
